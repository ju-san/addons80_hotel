...
class product_template(models.Model):
    ...
    pack_price_type = fields.Selection([
        ...
        ('none_detailed_assited_price', 'None Detailed - Detail Price Inside'),
        ('none_detailed_totaliced_price', 'None Detailed - Just Total Price'),
    ],
        'Pack Type', default='none_detailed_assited_price'
        )
    pack = fields.Boolean(
        'Is Package',
        help='Is a Product Package?',
        )
    pack_line_ids = fields.One2many(
